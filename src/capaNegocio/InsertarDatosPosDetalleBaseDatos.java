 ...
 * @author evallejos
 */
public class InsertarDatosPosDetalleBaseDatos {
    ...
    public void configurarConexion()
    {
        ...
        this.getCon1().setNombreTabla("PosDetail");
    ...
    public void insertarDatosPosDetalle(PosDetail pos)
    {
      
        this.configurarConexion();
        this.getCon1().setCadenaSQL("INSERT INTO "+this.getCon1().getNombreTabla()+" (id_transaccion,codigo,cantidad,importe)VALUES ('"+pos.getIdTransaccion()+"','"+pos.getCodigo()+"','"+pos.getCantidad()+"','"+pos.getImporte()+"')");
